...
const moodCards: MoodCard[] = [
  { id: 1, label: "감정이 깊어지는 이야기",value: "deep", images: "/images/pink.png" },
  { id: 2, label: "자극적인 이야기", value: "stimulating",  images: "/images/yellow.png" },
  { id: 3, label: "편안한 이야기", value: "calm", images: "/images/green.png" },
  { id: 4, label: "현실을 벗어나기", value: "escape", images: "/images/blue.png" },
  { id: 5, label: "아무 생각없기", value: "blank",images: "/images/purple.png" }
];
