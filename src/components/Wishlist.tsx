    ...
    <defs>
      ...
      >
        ...
        <feBlend
          ...
          result="effect1_dropShadow_folder"
        />
        <feBlend
          mode="normal"
          in="SourceGraphic"
          in2="effect1_dropShadow_folder"
          result="shape"
        />
      </filter>
      ...
      <radialGradient
        id="paint0_radial_folder"
        cx="0"
        cy="0"
        r="1"
        gradientTransform="matrix(12.566 19.436 -16.272 10.7933 116.642 96.48)"
...
const HamburgerIcon: React.FC = () => (
  ...
  >
    ...
    />
    <path
      d="M5 11C4.4477 11 4 11.4477 4 12C4 12.5523 4.4477 13 5 13H13C13.5523 13 14 12.5523 14 12C14 11.4477 13.5523 11 13 11H5Z"
      fill="white"
    />
  </svg>
);
...
const Wishlist: React.FC = () => {
  ...
  const [selectedFolder, setSelectedFolder] = useState<WishlistFolder | null>(
    null
  );
  ...
  useEffect(() => {
    ...
    if (sortOrder === "latest") {
      ...
      sorted.sort(
        (a, b) => (b.contents?.length || 0) - (a.contents?.length || 0)
      );
    }
  ...
  const handleFolderClick = (folder: WishlistFolder) => {
    if (!showEditPopup) navigate(`/wishlist/${folder.id}`);
  };
      ...
      {showCreatePopup && (
        <div className="popup-overlay" onClick={handlePopupOverlayClick}>
          <div className="popup-container">
            ...
            <button className="popup-save-btn" onClick={handleCreateFolder}>
              저장
            </button>
          </div>
        </div>
        ...
        <div className="popup-overlay" onClick={handlePopupOverlayClick}>
          <div className="popup-container popup-edit">
            ...
            <div className="popup-content">
              ...
              <button className="popup-delete-btn" onClick={handleDeleteFolder}>
                <TrashIcon />
                <span>휴지통</span>
              </button>
            </div>
            <button className="popup-save-btn" onClick={handleEditFolder}>
              저장
            </button>
          </div>
        </div>
