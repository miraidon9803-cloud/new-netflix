                ...
                <div className="storage-content">
                  {item.mediaType === 'tv' &&
                    ...
                    item.episode_number != null && (
                      <p className="ep">
                        {title} 시즌{item.season_number} : {item.episode_number}화
                      </p>
                    )}

                  {item.mediaType === 'movie' && <p className="title">{title}</p>}

                  <p className="del-btn" onClick={() => onRemoveWatching(activeProfileId, item)}>
                    삭제
                  </p>
                </div>
              </li>
